# We begin by Importing the data and performing basic data exploration phase
import pandas as pd
...
# Now Display the general information about the dataset
print(df.info())
...
catvars = ['location_type', 'cellphone_access', 'gender_of_respondent', 'relationship_with_head', 'education_level',
...
key = ['location_type', 'cellphone_access', 'gender_of_respondent', 'relationship_with_head', 'education_level',
